...
public class AirdropEntityModel extends GeoModel<AirdropEntity> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(RksAirdrops.MODID, "textures/entity/airdrop.png");
    private static final ResourceLocation ANIMATION = new ResourceLocation(RksAirdrops.MODID, "animations/airdrop.animation.json");
