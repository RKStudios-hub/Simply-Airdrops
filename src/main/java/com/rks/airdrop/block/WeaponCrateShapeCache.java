...
final class WeaponCrateShapeCache {
    private static final ShapeBox[] MODEL_BOXES = {
            new ShapeBox(-16.05, 0, -8, 15.95, 7, 8, 0, 0, 0, 6.75, -4, 4),
            new ShapeBox(8.35, -0.5, -8.65, 11.35, 12.5, 8.35, 0, 0, 0, 9.85, 1.5, -7.65),
            new ShapeBox(-11.45, -0.5, -8.65, -8.45, 12.5, 8.35, 0, 0, 0, -9.95, 1.5, -7.65),
            new ShapeBox(-16.35, 7, -8.2, 16.25, 12, 8.2, 0, 0, 0, -0.05, 7, 8),
            new ShapeBox(-2.75, 6, -9, 2.25, 8, -7, 0, 0, 0, -0.05, 7, 8)
    };
